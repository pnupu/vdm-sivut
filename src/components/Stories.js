...
const Stories = (props) => {
    ...
    return (
        <div className="stories">
            ...
            <Col>
            <p>
            “Kun rokotekeskustelu todenteolla alkoi viime syksynä, löysin paikkakuntani Facebook-ryhmästä päivityksen, jonka mukaan koronarokotteissa olisi mikrosiruja. Näillä päivityksen mukaan muodostettaisiin 1984-kirjan kaltainen valta hallitukselle, ja levitettäisiin vaarallisia 5G-säteilyitä. Luettuani muutamia viikkoja lisää aiheesta törmäsin Piikittäjien kampanjaan koronarokotteen turvallisuudesta, mikä sai minut tajuamaan asioiden todellisuuden. Löytämäni mikrosirukaaviotkin olivat todellisuudessa kitaran vahvistimen virtapiirikuvia! Asenteeni rokotteesta on muuttunut, ja riskiryhmäläisenä sen olen jo ottanut. Pelko on kaikonnut elämästäni.”
            </p>
            </Col>
            </Row>
            </div>
